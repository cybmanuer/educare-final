                ...
                <!-- <div class="info"> -->
                    <section class="home-section">
                        ...
                        <div class="header"><h3>WELCOME <i class="fa-solid fa-bolt"></i> <span>`<?php echo strtoupper($_SESSION['s_reg'] )?>` </span>
                          <a href="login.php"><i class="fa-solid fa-right-from-bracket" id="i2"></i></a> </h3>
                        </div>
                      ...
                      ini_set('display_errors', 0);
                          ...
                          // $sql = "SELECT msg FROM notification WHERE id = '1' ";
                        $sql = "SELECT msg,id FROM notification LIMIT 1";
                     ...
                     <p><?php echo $row['msg']; ?></p>
                      ...
                      <div class="not1">
                        ...
                        $sql = "SELECT msg,id FROM notification LIMIT 1,1";
                          $result = $conn-> query($sql);
                          $row = mysqli_fetch_assoc($result);  
                        ?>
                        <p><?php echo $row['msg']; ?></p>
                    ...
                    <!-- NOTIFICATION 3 -->
                      <div class="not1">
                        ...
                        $sql = "SELECT msg,id FROM notification LIMIT 2,1";
                          $result = $conn-> query($sql);
                          $row = mysqli_fetch_assoc($result);  
                        ?>
                        <p><?php echo $row['msg']; ?></p>    
                    ...
                    <!-- <div class="not1"><i class="fa-solid fa-bell"></i></div>
                    <div class="not1"><i class="fa-solid fa-bell"></i></div>
                    <div class="not1"><i class="fa-solid fa-bell"></i></div> -->
                        ...
                        <div class="row1-container">
                          ...
                          <div class="box red"><a href="time-table.html">
                            <h2>TIME-TABLE</h2>
                          ...
                          <div class="box cyan"><a href="attendence1.php">
                            <h2>ATTENDENCE</h2>
