            ...
            <div class="main_content">
                ...
                <!-- <div class="info"> -->
                    <section class="home-section">
                        ...
                        <div class="header"><h3>WELCOME <i class="fa-solid fa-hand-point-right"></i> <span>`<?php echo strtoupper($_SESSION['a_name'] )?>` </span>
                        <a href="login.php"><i class="fa-solid fa-right-from-bracket" id="i2"></i></a>
                       </h3>
                      </div>
